    ...
    if ($opcaoscanner == "0") {
        ...
        if (!empty($arquivoObbStr)) {
            ...
            if (!empty($resultadoDataObbStr)) {
                ...
                if ($dataObb) {
                    $dataObbFormatada = $dataObb->format('d-m-Y H:i:s');
                    echo $amarelo . "[*] Data de modificação do arquivo OBB: " . $dataObbFormatada . "\n";
                } else {
                    echo $amarelo . "[*] Data de modificação do arquivo OBB: " . substr($resultadoDataObbStr, 0, 19) . "\n";
                }
            } else {
