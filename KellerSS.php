...
// Cores do scanner original (mais vibrantes e organizadas)
$branco = "\e[97m";
$preto = "\e[30m\e[1m";
$amarelo = "\e[93m";
$laranja = "\e[38;5;208m";
...
// Banner do original (mais bonito)
...
// Função detectarBypassShell com interface do original
function detectarBypassShell() {
    ...
    echo "\n" . $bold . $azul . "┌─────────────────────────────────────────────────────────────────┐\n";
    echo $bold . $azul . "│ [11] VERIFICANDO FUNÇOES SHELL SOBRESCRITAS                     │\n";
    echo $bold . $azul . "└─────────────────────────────────────────────────────────────────┘\n" . $cln;
    delay1();
...
// Função escanearFreeFire com interface do original
