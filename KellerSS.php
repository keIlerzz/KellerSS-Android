...
escolheropcoes:
    ...
    if ($opcaoscanner == "0") {
        ...
        // Todas as verificações são executadas internamente, mas apenas mensagens genéricas são exibidas
        echo $bold . $fverde . "[i] Nenhum bypass de holograma detectado.\n\n";
        ...
        if (shell_exec('adb shell "test -d ' . escapeshellarg($diretorioAvatarRes) . ' && echo existe"')) {
